...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>添加、编辑组合-后台管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='组合管理 > 添加编辑组合'; ?>
                ...
                <div id="Right">
                    ...
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            ...
                            <tr>
                                <th width="100">组合介绍：</th>
                                <td><input id="ename" type="text" class="input" size="40" name="info[ename]" value="<?php echo ($info["ename"]); ?>"/></td>
                            </tr>

                            <tr>
                                <th width="100">组合发布状态：</th>
                                <td><?php if(ACTION_NAME == 'add')$info['status'] = 1; ?><label><input type="radio" name="info[status]" value="1" <?php if($info["status"] == 1): ?>checked="checked"<?php endif; ?> />组合已发布状态</label> &nbsp; <label><input type="radio" name="info[status]" value="0" <?php if($info["status"] == 0): ?>checked="checked"<?php endif; ?> /> 待审核状态</label> </td>
                            </tr>
                            <tr>
                                <th>组合所属分类：</th>
                                <td>
                        ...
                        <?php }else{ $action_url='/yuanzhan/jkd/Product/add'; } ?>
                    </form>
            ...
            $(function(){
                ...
                KindEditor.ready(function(K) {
                    content = K.create('#content',{
                        ...
                        uploadJson:'/yuanzhan/Public/kindeditor/php/upload_json.php?dirname=product'
                    });
                });
                ...
                $("#checkNewsTitle").click(function(){
                    ...
                    $.getJSON("/yuanzhan/jkd/Product/checkProductTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
