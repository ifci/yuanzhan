...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>组合管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='组合管理 > 组合列表'; ?>
                ...
                <div id="Right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                <td align="left"><img src="/yuanzhan/Public/Img/<?php echo ($vo["lang"]); ?>.png"><a href="/yuanzhan/jkd/Product/edit?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
                                ...
                                <td><a href="javascript:void(0);"  title="推荐" onclick="changeAttr(<?php echo ($vo["id"]); ?>,this)"><img src="/yuanzhan/Public/Img/action_<?php echo ($vo["is_recommend"]); ?>.png" border="0"></a>
                                    &nbsp;&nbsp;
                                    <a href="javascript:void(0);" title="推荐到手机" onclick="changePhoneStatus(<?php echo ($vo["id"]); ?>,this)"><img src="/yuanzhan/Public/Img/iphone-<?php echo ($vo["wap_display"]); ?>.png" border="0">
                                </td>
                                <td>[ <a href="/yuanzhan/jkd/Product/edit?id=<?php echo ($vo["id"]); ?>&do=copy">复制 </a> ][ <a href="/yuanzhan/jkd/Product/edit?id=<?php echo ($vo["id"]); ?>">编辑 </a> ] [ <a link="<?php echo U('Product/del/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["title"]); ?>" class="del">删除 </a> ]</td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr><td colspan="7" align="right"><?php echo ($page); ?></td></td></tr>


                        <tr><td colspan="7" align="left">
                            <form action="/yuanzhan/jkd/Product/index.html" method="get">
