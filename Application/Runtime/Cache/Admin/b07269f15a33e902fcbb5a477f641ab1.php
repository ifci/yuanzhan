...
<script type="text/javascript">
    $(function(){
        ...
        $("#checkPageTitle").click(function(){
            ...
            $.getJSON("/yuanzhan/jkd/Video/checkPageTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
        ...
        $("#checkPageUnique").click(function(){
            ...
            $.getJSON("/yuanzhan/jkd/Video/checkPageUnique", { title:$("#unique_id").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
