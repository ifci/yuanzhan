...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>组合分类管理-组合管理-后台管理首页-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='组合管理 > 组合分类管理'; ?>
...
<div class="clear"></div>
    ...
    <div class="subMenuList">
            ...
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    ...
                    <form action="" method="post" id="quickForm">
                        ...
                        <input placeholder="分类的英文名" class="input" type="text" name="data[ename]" value="" style="width:80px" />
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab">
                        <thead>
                            <tr align="center">
                                ...
                                <td width="10%">原分类结构 <b title="单击分类隐藏/显示该分类下在子类">[i]</b></td>
                                <td width="20%" align="left">操作属性</td>
                                <td width="20%">新分类</td>
                                <td width="20%">修改后的名称</td>
                                <td width="20%">修改后的英文名</td>
                                <td width="10%">操作</td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tree): $mod = ($i % 2 );++$i;?><tr pid="<?php echo ($tree["pid"]); ?>" cid="<?php echo ($tree["cid"]); ?>">
                                    ...
                                    <td width="10%" class="tree" style="cursor: pointer;"><?php echo ($tree["fullname"]); ?><div><?php echo ($tree["ename"]); ?></div></td>
                                    <td width="20%">
                                    ...
                                    <td width="20%"><input type="text" value="" name="ename" class="input" placeholder="修改后的英文名称" style="width:140px"/></td>
        ...
        <form action="" method="post" id="opForm">
            ...
            <input id="ename" type="hidden" name="data[ename]" />
        </form>
        <div class="clear"></div>
        ...
        <script type="text/javascript">
            $(function(){
                $(".opCat").click(function(){
                    ...
                    $("#ename").val(obj.find("input[name='ename']").val());
                    if($("#act").val()=="del"){
