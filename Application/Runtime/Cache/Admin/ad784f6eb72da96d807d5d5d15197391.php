...
<script type="text/javascript">
    $(function(){
        ...
        $("#checkPageTitle").click(function(){
            ...
            $.getJSON("/yuanzhan/jkd/Honor/checkPageTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
        ...
        $("#checkPageUnique").click(function(){
            ...
            $.getJSON("/yuanzhan/jkd/Honor/checkPageUnique", { title:$("#unique_id").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
