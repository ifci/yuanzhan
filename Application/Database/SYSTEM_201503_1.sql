...
# Type: 系统自动备份
# Description:当前SQL文件包含了表：jkd_access、jkd_ad、jkd_admin、jkd_category、jkd_field、jkd_images、jkd_input、jkd_link、jkd_member、jkd_message、jkd_model、jkd_nav、jkd_news、jkd_node、jkd_page、jkd_product、jkd_role、jkd_role_user、jkd_tag的结构信息，表：jkd_access、jkd_ad、jkd_admin、jkd_category、jkd_field、jkd_images、jkd_input、jkd_link、jkd_member、jkd_message、jkd_model、jkd_nav、jkd_news、jkd_node、jkd_page、jkd_product、jkd_role、jkd_role_user、jkd_tag的数据
# Time: 2015-03-28 20:34:48
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------
...
# 数据库表：jkd_ad 数据信息
INSERT INTO `jkd_ad` VALUES ('23','首页1','http://www.2345.com/?kconist','531e85f90bcc1.png','index','10','zh-cn');
INSERT INTO `jkd_ad` VALUES ('24','首页2','http://www.2345.com/?kconist','531e88216e887.png','index','9','zh-cn');
INSERT INTO `jkd_ad` VALUES ('25','首页3','http://www.2345.com/?kconist','531e88325b1c2.png','index','8','zh-cn');
